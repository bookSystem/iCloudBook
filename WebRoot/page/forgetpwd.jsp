    ...
    <div class="container">
        <div class="register-box">
            <div align="center"
                ...
                <div style="margin:0 auto;width: 165px;height:35px;line-height:35px;color: rgba(51,51,51,0.9);">找回密码</div>
            </div>
            <form id="form1" style="width:80%;margin: 0 auto;display: block;" method="post" action="user_forgetPwd.action">
