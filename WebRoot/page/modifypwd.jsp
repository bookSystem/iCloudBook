...
//prev
    ...
    <div class="container">
        <div class="register-box">
            ...
            <form id="form1" style="width:80%;margin: 0 auto;display: block;" method="post" action="user_updatePwd.action">
                ...
                <div class="input-group" style="padding-top: 30px;">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="旧密码" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
