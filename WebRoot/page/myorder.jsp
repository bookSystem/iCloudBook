        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9" id="workspace" role="main">
            ...
            <div class="row hidden-print">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="book_findLastBook.action">首页</a></li>
                ...
                <table class="table table-condensed table-hover text-center"
                    ...
                    <tr>
                        ...
                        <td><c:choose>
							...
							<c:when test="${item.isDeal eq 0}"><span>等待发货</span></c:when>
							<c:when test="${item.isDeal eq 1}"><span><a href="order_firmOrder.action?orderItemId=${item.orderItemId }">确认收货</a></span></c:when>
							<c:when test="${item.isDeal eq 2}"><span>交易成功</span></c:when>
						</c:choose>	
						</td>
