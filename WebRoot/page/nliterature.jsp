...
<input type="hidden" name="hiddenflag" value="1">
<main>
<div class="main_container">
	...
	<div class="bookcatalog">
		<c:forEach items="${bookBean.list }" var="book">
			...
			<a id="catalog_a11"
				href="book_BookItem.action?bookId=${book.bookId }">
				<div id="catalog_div11" class="catalog">
					<div class="imgdiv">
						<img alt="" src="${pageContext.request.contextPath}/${book.image}">
					</div>
					<div class="introduce">
						<span id="price11" style="font-size: 20px;color: red">¥${book.bookPrice
							}</span><br> <span id="bookname11">${book.bookName }</span><br>
