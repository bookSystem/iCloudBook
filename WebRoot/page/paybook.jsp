                                ...
                                <table class="table table-condensed table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 100px;text-align: center">金额小计</th>
		                                    ...
		                                    <tbody>
		                                    <tr>
		                                        <td>${paybook.bookNo }</td>
		                                        <td>${paybook.bookName }</td>
		                                        <td>${paybook.bookPrice }</td>
		                                        <td>${num }</td>
		                                        <td>${num * paybook.bookPrice}</td>
		                                     </tr>
		                                    </tbody>
	                                    ...
	                                    <tr>
	                                        <td colspan="7" class="text-right">
	                                            <p class="form-control-static">
	                                              	  产品合计：<span class="large-bold-red">￥${num * paybook.bookPrice} 元</span>
	                                            </p>
	                                        </td>
	                                    </tr>
	                                    </tfoot>
